    ...
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          ...
          content: const Text(
            "You can press and hold on any image to see a preview with more details about that option.",
      ...
      appBar: AppBar(
        ...
        leading: widget.onPrevious != null
          ...
          onPressed: widget.onPrevious,
            ...
            : null,
        // NEW: Info icon in app bar actions
        actions: [
          IconButton(
            icon: const Icon(Icons.info_outline),
            onPressed: _showInfoDialog,
            tooltip: "Show tips", // Optional tooltip
          ),
        ],
      ),
