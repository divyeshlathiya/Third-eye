    ...
    try {
      if (widget.isMale) {
        images = await Future.wait([
          ...
          FirebaseStorage.instance.ref('male/q4-20.png').getDownloadURL(),
          FirebaseStorage.instance.ref('male/q4-10.png').getDownloadURL(),
          FirebaseStorage.instance.ref('male/q4-0.png').getDownloadURL(),
          FirebaseStorage.instance.ref('male/q4-neg10.png').getDownloadURL(),
          FirebaseStorage.instance.ref('male/q4-neg20.png').getDownloadURL(),
        ...
        images = await Future.wait([
          ...
          FirebaseStorage.instance.ref('female/fq4-10.png').getDownloadURL(),
          FirebaseStorage.instance.ref('female/agna.png').getDownloadURL(),
          FirebaseStorage.instance.ref('female/agna.png').getDownloadURL(),
          FirebaseStorage.instance.ref('female/fq4-0.png').getDownloadURL(),
          FirebaseStorage.instance.ref('female/agna.png').getDownloadURL(),
          FirebaseStorage.instance.ref('female/agna.png').getDownloadURL(),
          FirebaseStorage.instance.ref('female/fq4-neg10.png').getDownloadURL(),
          FirebaseStorage.instance.ref('female/agna.png').getDownloadURL(),
        ]);
